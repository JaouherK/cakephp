...
<div class="col-md-6">
    <div class="box same-height">
        ...
        echo $this->Form->create('User', array(
            'url' => array(
                'controller' => 'users',
                'action' => 'realtor_signup')), array('role' => 'form'));
        ?>
        ...
        <?php echo $this->Form->input('role', array('type' => 'hidden', 'class' => 'form-control', 'value' => 'realtor')); ?>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <?php echo $this->Form->input('supplier_type', array('label' => false, 'required' => 'required', 'class' => 'form-control', 'div' => false, 'empty'=>'--- Choose ---', 'options' => array('Area Licensee' => 'Area Licensee', 'Individual' => 'Individual',  'Angel' => 'Angel', 'Corporate' => 'Corporate', 'VCT Manager' => 'VCT Manager', 'Institutional' => 'Institutional', 'FCA Adviser' => 'FCA Adviser'))); ?>
            </div>
        ...
        <div class="form-group hidden">
            <label for="postcee" class="col-sm-4 control-label">Area Code</label>
