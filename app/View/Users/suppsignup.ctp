...
<div class="col-md-6">
    <div class="box same-height">
        ...
        <?php echo $this->Form->input('role', array('type' => 'hidden', 'class' => 'form-control', 'value' => 'shop')); ?>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <?php echo $this->Form->input('supplier_type', array('label' => false, 'required' => 'required', 'class' => 'form-control', 'div' => false, 'empty'=>'--- Choose ---', 'options' => array('Manufacturer' => 'Manufacturer', 'Distributor' => 'Distributor', 'Representative' => 'Representative', 'Franchise' => 'Franchise', 'Other' => 'Other'))); ?>
            </div>
        </div>
        <div class="form-group">
