<div class="noscroll-x column tab-column main-tab-column hidden-print ember-view" id="menu">
    <ul class="nav nav-pills nav-stacked fill nav-bottom-spacing zi-main-tab">

        <li class="ember-view">
            <a href="<?php echo $this->webroot; ?>" class="<ember-view">
                <i class="spaced fa fa-arrow-left"></i> <?= __('Back'); ?>
            </a>
        </li>
        <li class="divider-md"></li>


        <li class="<?php if (in_array($level_config, array(
            'conf1',
            'HintVideo',
            'HintFaq'

        ))) echo "active" ?> ember-view">
            <a href="<?php echo $this->webroot; ?>configurations"
               class="<?php if (in_array($level_config, array(
                   'conf1',
                   'HintVideo',
                   'HintFaq'
               ))) echo "active" ?> ember-view">
                <i class="spaced fa fa-briefcase"></i> <?= __('Configutrations'); ?>
            </a>
        </li>
