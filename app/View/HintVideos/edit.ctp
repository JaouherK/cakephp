<div class="column content-column">
            ...
            <div class="btn-toolbar pull-right">
                ...
                <div class="btn-group">
                    <?php echo $this->Form->postLink(__('<i class="fa fa-trash"></i>'),
                        array('action' => 'delete', $this->Form->value('HintVideo.id')),
                        array('class' => 'btn btn-danger', 'escape' => false),
                        __('Are you sure you want to delete # %s?', $this->Form->value('HintVideo.id'))); ?>
    ...
    <div id="ember2410" class="scroll-y noscroll-x fill body scrollbox ember-view">
        ...
        <div class="hintVideos form zb-txn-form">
            <div class="col-md-8">
                <?php echo $this->Form->create('HintVideo', array('role' => 'form')); ?>
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        <?php echo $this->Form->input('length', array('class' => 'form-control')); ?>
                    </div><!-- .form-group -->
                    <div class="form-group">
